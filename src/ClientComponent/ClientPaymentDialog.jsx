      ...
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl w-full">
        ...
        <div className="flex space-x-4 mb-4">
          <div className="flex-1">
            ...
            <input
              ...
              max={total}
              className={`mt-2 text-gray-900 border ${amountError ? 'border-red-500' : 'border-gray-900'
        ...
        <div className="flex w-full space-x-4">
          ...
          <button
            ...
            className={`w-1/2 px-4 py-2 text-lg font-bold uppercase rounded-2xl ${!paymentData.amount ||
                !paymentData.payer ||
                amountError
