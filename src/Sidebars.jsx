      ...
      <div className="px-0 py-0 flex-1">
        <ul className="mt-4 space-y-2 border-t border-red-400 pt-4 text-white">
          ...
          {isAdmin && (
            <>
              <li>
                <Link to="/client" className="flex items-center mt-20 font-bold text-white text-lg hover:bg-red-600 hover:mr-5 hover:ml-5 rounded-md px-4 py-2 transition">
              ...
              <li>
                <Link to="/localization" className="flex items-center font-bold text-white text-lg hover:bg-red-600 hover:mr-5 hover:ml-5rounded-md px-4 py-2 transition">
