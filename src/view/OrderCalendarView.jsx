        ...
        while (day <= endDate) {
            for (let i = 0; i < 7; i++) {
                ...
                days.push(
                    <div
                        key={dayStr}
                        className={`p-2 border-2 min-h-[80px] text-sm rounded transition flex flex-col justify-between ${!isCurrentMonth ? "bg-gray-100 text-gray-300" : "bg-white text-gray-800"
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2 items-center">
                    <select value={currentDate.getMonth()} onChange={handleMonthChange}
                        className="border text-gray-900 px-2 py-1 font-bold rounded-2xl">
                    ...
                    <select
                        ...
                        className="border px-2 py-1 rounded-2xl text-gray-900 font-bold"
                    >
                    ...
                    <div className="relative p-4 w-full max-w-2xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                            ...
                            <div className="p-4 md:p-5 space-y-4 max-h-96 overflow-y-auto">
                                {modalEvents.map((event, idx) => {
                                    ...
                                    return (
                                        <div
                                            key={idx}
                                            className={`px-2 py-1 rounded-lg border-2 border-gray-900 text-sm font-semibold truncate ${color}`}
                                            title={event.client}
                                            onClick={() => {
                                                setSelectedItem(event);
                                                setShowModal1(true);
                            ...
                            <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                <button
                                    type="button"
                                    className="text-white bg-[#D3423E] uppercase font-bold  rounded-3xl text-m px-5 py-2.5 text-center"
                                    onClick={closeModal}
                                >
                                    Cerrar
                                </button>
