...
export default function LocalizationView() {
  ...
  const center = { lat: -17.3835, lng: -66.1568 };
      ...
      <div className="w-2/6 overflow-y-auto border-r-2 border-gray-200">
        ...
        <div className="px-4 py-4 grid grid-cols-1 gap-6">
          {filteredData.map((client) => (
            <a key={client._id} href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-lg md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
              <img
